...
> ⚠️ לשימוש חוקי, מקומי וחינוכי בלבד. המדריך עוקב אחרי סביבת **מסד הנתונים על Windows** (ראה README), ולכן הפקודות הן של Windows (`dir`, `type`) והדגל נמצא ב-`C:\Users\Public\Flag.txt`.
